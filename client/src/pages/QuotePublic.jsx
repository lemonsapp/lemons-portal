...
export default function QuotePublic() {
  ...
  return (
    <div style={{
      minHeight: "100vh",
      background: "linear-gradient(135deg, #080d1c 0%, #0b1428 50%, #080d1c 100%)",
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ fontWeight: 900, fontSize: 16, letterSpacing: "-0.3px" }}>LEMON'S</div>
            <div style={{ fontSize: 11, color: "rgba(255,255,255,0.40)" }}>Logística Internacional</div>
          </div>
        </div>
        <a href="/login" style={{
      ...
      <div style={{ textAlign: "center", padding: "48px 24px 32px" }}>
        <div style={{
          ...
          color: "#ffd200", background: "rgba(255,210,0,0.10)", padding: "4px 14px",
          borderRadius: 20, marginBottom: 16, border: "1px solid rgba(255,210,0,0.20)",
        ...
        <p style={{ fontSize: 16, color: "rgba(255,255,255,0.50)", margin: 0, maxWidth: 480, marginInline: "auto" }}>
          Calculá al instante el costo de traer tus productos desde USA, China o Europa.
        </p>
      </div>
          ...
          {hasResult && (
            <div style={{
              ...
              <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 14 }}>
                ...
                <div style={{ fontSize: 36, fontWeight: 900, color: "#ffd200", letterSpacing: "-1px" }}>
                  {fmtUsd(totalUsd)}
                </div>
                {totalArs && (
